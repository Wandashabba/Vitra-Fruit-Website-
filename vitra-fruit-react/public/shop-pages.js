(function () {
  ...
  const searchIndex = [
    ...
    { label: 'Lemon Wheel', href: 'lemon-wheel.html', tags: ['lemon', 'citrus', 'wheel', 'wheels'] },
    { label: 'Orange Wheel', href: 'orange-wheel.html', tags: ['orange', 'citrus', 'wheel', 'wheels'] },
    { label: 'Lime Wheel', href: 'lime-wheel.html', tags: ['lime', 'citrus', 'wheel', 'wheels'] },
    { label: 'Grapefruit Wheel', href: 'grapefruit-wheel.html', tags: ['grapefruit', 'citrus', 'wheel', 'wheels'] },
